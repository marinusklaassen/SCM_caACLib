...
EXAMPLE:
SCMPresetView(bounds:500@50, contextId: "mycontext").front().actionFetchPreset_({ 1000.rand.postln; }).actionLoadPreset_({ |preset| preset.postln });
*/
...
SCMPresetView : View {
	...
	*initClass {
	...
	initializeView{
		...
		notificationMessageLabel = SCMMessageLabelViewFactory.createInstance(this, class: "message-info");
