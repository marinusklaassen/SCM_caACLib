...
SCMControlSpecView(bounds:400@20).front().action = { |sender| sender.controlSpec.postln; sender.getState().postln; };
*/

SCMControlSpecView : View {
